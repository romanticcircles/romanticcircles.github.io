 ...
 */
#$db_url = 'mysqli://5ard0n1cu5:Ka11f0rn1a@localhost/drupaldb';
#$db_prefix = '';
 ...
 * for you.
 */
#$base_url = 'http://174.129.6.250/rc-d6';  // NO trailing slash!
#$base_url = 'http://www.rc.umd.edu';
/**
 * PHP settings:
 *
...
$drupal_hash_salt = 'FWo7WO-CiqTrv_ucvL1OVLh_jWJt8kI2YUhtf70lmlc';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_romanticcircles_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_romanticcircles_dev_default.inc';
}
// </DDSETTINGS>
