...
class __TwigTemplate_ed8217febe14e2c956e077be3da552a593c70aad1bb10b69be8b412e47445bca extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<h3> 
    ";
        // line 7
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed(($context["field_author_ref"] ?? null), 7, $this->source)), "html", null, true);
        echo " 
    ";
        // line 8
        if (($context["field_collaborator"] ?? null)) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed(($context["field_collaborator"] ?? null), 9, $this->source)), "html", null, true);
            echo "
    ";
        }
        // line 11
...
<p> ";
        // line 12
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed(($context["field_description"] ?? null), 12, $this->source)), "html", null, true);
        echo " </p>
</a>
</div>
</div>
