...
class __TwigTemplate_c7585c503bb87fcfa57c205cd699c6857c330f80e4cf216eda5dee7f408fccaf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/var/www/html/drupal/Romantic-Circles-Site/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
